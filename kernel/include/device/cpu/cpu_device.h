...
namespace rayshape
{
    namespace device
    {
        ...
        public:
            ...
            virtual ErrorCode CopyToDevice(Buffer *dst, const Buffer *src, void *command_queue = nullptr);

            virtual ErrorCode CopyFromDevice(Buffer *dst, const Buffer *src, void *command_queue = nullptr);
        };
    } // namespace device
} // namespace rayshape
